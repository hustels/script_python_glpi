...
print sheet.cell_value(0,0) # index del valor fila e index del valor columna
...
#Database connection
conn = mysql.connector.connect(user='root', password='root' , host='localhost' , database='glpi')
# Crear el cursor
